...
class Unet(nn.Module):
    def __init__(self):
        ...
        """定义上采样网络"""
        self.decoder1 = nn.Sequential(nn.ConvTranspose2d(1024,512, kernel_size=2, stride=2))
        ...
        self.decoder_output = nn.Conv2d(64,2, kernel_size=5, stride=1, padding=2)
    ...
    def forward(self, x):
        ...
        d1 = self.decoder1(e5)
        d1 = torch.cat((d1, e4), dim=1)#torch.cat用于拼接维度
